...
#PD
    ...
    def emmo(self,filenrc):
        ...
        self.merged_df['Trauer'] = self.merged_df['Trauer']* self.merged_df['Häufigkeit']
        self.merged_df['Wut'] = self.merged_df['Wut']* self.merged_df['Häufigkeit']
        self.merged_df['Verachtung'] = self.merged_df['Verachtung']* self.merged_df['Häufigkeit']
...
#        self.merged_df.sort_values('Häufigkeit')
        ...
        print("-------------------------------------------------------------------------------------------")
        print(" Häufigkeitsverteilung der 7 Emotionen:")
        print("-")
        print((self.E_sum[1:]))
        self.ser = self.E_sum[10],self.E_sum[5],self.E_sum[8],self.E_sum[6],self.E_sum[7],self.E_sum[9],self.E_sum[4]
#        print(self.ser)
...
my_stop_words = ['alexander','kirchenmayer','mayer','schmidt','–','schorcht','zeller','helga','ursula']
#
...
run.plot_encoded()
#print(run.df)
emmo_lexicon = './RKlinger_clean.CSV'
...
plt.pie(data,labels=ingredients, colors=['red','orange','yellow','green','blue','purple','black'])
#

ax.set_title("Paul Ekman 7 Emotionen: ")
